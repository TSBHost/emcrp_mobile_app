...
public class RecyleSubtaskAdapter extends RecyclerView.Adapter<RecyleSubtaskAdapter.CustomVHolder> {

    private Context context;
    List<SubtaskModel> data = Collections.emptyList();
    Cursor mCursor;


    public RecyleSubtaskAdapter(Context context, Cursor data) {
    ...
    public CustomVHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.stask_list, parent, false);
